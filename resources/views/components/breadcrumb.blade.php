...
'imports.master-items' => [$breadcrumbs[] = ['label' => 'Master', 'route' => null], $breadcrumbs[] = ['label' => 'Import']],
...
'imports.kategoris' => [$breadcrumbs[] = ['label' => 'Master', 'route' => null], $breadcrumbs[] = ['label' => 'Category', 'route' => 'kategoris.index'], $breadcrumbs[] = ['label' => 'Import Category']],
