@php
    ...
    $labels = match ($name) {
        ...
        'allokasis.create' => ['Dashboard', 'Budgeting', 'Add Non-Project'],
        'allokasis.edit' => ['Dashboard', 'Budgeting', 'Edit Allocation'],
        ...
        @foreach ($labels as $index => $label)
            ...
            <li>
                ...
                @elseif ($index === count($labels) - 1)
                    <span class="block max-w-[220px] truncate font-semibold text-slate-800">{{ $label }}</span>
                @else
