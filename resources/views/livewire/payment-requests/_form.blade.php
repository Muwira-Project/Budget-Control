<div class="mt-6 grid grid-cols-1 gap-6">
    ...
    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
        ...
        <div>
            <x-input-label for="prioritas" :value="__('Payment Priority')" />
            <select id="prioritas" wire:model="prioritas" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
    ...
    <div>
        ...
        <textarea id="keterangan" wire:model="keterangan" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" placeholder="Payment details"></textarea>
