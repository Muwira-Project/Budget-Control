<div class="mt-6 grid grid-cols-1 gap-6">
    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
        ...
        <div>
            <x-input-label for="akun_id" :value="__('Account (COA)')" />
            <select id="akun_id" wire:model="akunId" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" required>
    ...
    <div>
        <x-input-label for="pihak_jenis" :value="__('Party (optional)')" />
        <div class="mt-1 flex flex-wrap gap-4">
            <label class="inline-flex items-center">
                <input type="radio" wire:model.live="pihakJenis" value="none" class="rounded border-gray-300 text-blue-600 focus:ring-blue-500" />
                <span class="ms-2 text-sm text-gray-700">None</span>
            </label>
            <label class="inline-flex items-center">
    ...
    @if ($pihakJenis === 'vendor')
        <div>
            ...
            <select id="vendor_id" wire:model="vendorId" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
    ...
    @elseif ($pihakJenis === 'supplier')
        <div>
            ...
            <select id="supplier_id" wire:model="supplierId" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
    ...
    @elseif ($pihakJenis === 'mandor')
        <div>
            ...
            <select id="mandor_id" wire:model="mandorId" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
    ...
    @elseif ($pihakJenis === 'investor')
        <div>
            ...
            <select id="investor_id" wire:model="investorId" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
    ...
    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
        <div>
            ...
            <x-text-input id="nominal" class="mt-1 block w-full" type="text" wire:model="nominal" placeholder="e.g. 5000000" required />
            <x-input-error :messages="$errors->get('nominal')" class="mt-2" />
        </div>

        <div>
            <x-input-label for="keterangan" :value="__('Description (optional)')" />
            <x-text-input id="keterangan" class="mt-1 block w-full" type="text" wire:model="keterangan" placeholder="e.g. Listrik kantor bulan Juli" />
