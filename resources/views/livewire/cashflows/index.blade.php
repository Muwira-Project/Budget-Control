<div class="py-12">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <h2 class="text-xl font-semibold text-gray-800 leading-tight">{{ __('Cashflow') }}</h2>
            ...
            <x-bulk-actions :paginator="$this->cashflows" :selected-ids="$this->selectedIds" />
                ...
                @elseif ($this->cashflows->isEmpty())
                    <p class="p-6 text-sm text-gray-500">
                        {{ $this->startDate !== null || $this->endDate !== null || $this->jenisFilter !== '' ? 'No cash records match the filter.' : 'No cash records yet. Click "Add Income" or mark a payment request as paid.' }}
                    </p>
                @else
