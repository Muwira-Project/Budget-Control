<div class="py-12">
    <div class="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
        <h2 class="text-xl font-semibold text-gray-800 leading-tight">{{ __('Edit Master Menu') }}</h2>
        <p class="mt-1 text-sm text-gray-500">Ubah nama, status, atau kolom dari menu master. Perubahan kolom berlaku untuk data baru.</p>
