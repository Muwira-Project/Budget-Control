<div class="py-12">
    <div class="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
        <h2 class="text-xl font-semibold text-gray-800 leading-tight">{{ __('Add Fund Transfer') }}</h2>
        ...
        <form wire:submit="save" class="mt-6 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-200">
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <select id="dari" wire:model="dariCashAccountId" class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        ...
                        @foreach (\App\Models\CashAccount::where('status', 'active')->orderBy('kode')->get() as $account)
            ...
            <div class="mt-6 flex items-center gap-3">
                ...
                <a href="{{ route('fund-transfers.index') }}" wire:navigate class="text-sm font-medium text-gray-600 hover:text-gray-900">Cancel</a>
            </div>
        </form>
    </div>
</div>