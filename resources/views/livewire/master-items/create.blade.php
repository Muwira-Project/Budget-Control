<div class="py-12">
    <div class="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
        <h2 class="text-xl font-semibold text-gray-800 leading-tight">{{ __('Add') }} {{ $this->masterType->nama }}</h2>
        ...
        <form wire:submit="save" class="mt-6 rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-200">
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                @if ($this->masterType->flag_ar || $this->masterType->flag_ap)
                    <div class="sm:col-span-2 rounded-lg border border-gray-200 bg-gray-50 p-4">
                        ...
                        <p class="mt-0.5 text-xs text-gray-500">Tentukan di sisi mana item ini boleh dipilih sebagai pihak transaksi. Kosongkan keduanya = netral (muncul di semua dropdown).</p>
            ...
            <div class="mt-6 flex items-center gap-3">
                ...
                <a href="{{ route('master-items.index', $this->masterType) }}" wire:navigate class="text-sm font-medium text-gray-600 hover:text-gray-900">Cancel</a>
            </div>
        </form>
    </div>
</div>