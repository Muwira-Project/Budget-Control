<div class="py-12">
    <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <a href="{{ route('imports.payables.template', ['use_project_code' => $useProjectCode]) }}" class="inline-flex items-center justify-center rounded-lg border border-blue-600 bg-white px-4 py-2 text-sm font-semibold text-blue-600 shadow-sm hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                Download Template
            </a>
        </div>
            ...
            <form wire:submit="import" class="p-6">
                <div class="mb-4">
                    <label class="inline-flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" wire:model="useProjectCode" class="h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500" />
                        <span class="text-sm text-gray-700">{{ $useProjectCode ? 'Gunakan Project Code' : 'Tanpa Project Code (Invoice unik global)' }}</span>
                    </label>
                ...
                <p class="text-sm text-gray-500">
                    ...
                    <code class="bg-gray-100 px-1 rounded">investor</code>.
