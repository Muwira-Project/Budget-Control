...
class CashflowTemplateExport implements FromArray
{
    ...
    public function array(): array
    {
        return [
            ...
            ['2026-08-15', 'masuk', 'pendapatan', 'BANK-001', '4-101', 'PRJ-2025-001', 'VENDOR', 'VND-001', 50000000, 'Pembayaran termin 1 (Proyek)'],
            ['2026-08-20', 'keluar', 'pengeluaran_lain', 'BANK-001', '5-101', '', 'SUPPLIER', 'SPL-001', 25000000, 'Pembelian material operasional (Non-Proyek / Kosong)'],
            ['2026-08-21', 'keluar', 'pengeluaran_lain', 'KAS-001', '6-101', 'NON-PROJECT', '', '', 500000, 'Biaya listrik & utilitas kantor (Non-Proyek)'],
            [],
            ...
            ['Project: use project kode for project transactions. For Non-Project, leave blank or write "-", "NON-PROJECT"'],
